<template>
  <div
    class="tool-display skill-tool"
    :class="statusClass"
  >
    <!-- 工具头部 -->
    <div class="tool-header">
      <span class="tool-icon">🎯</span>
      <span class="tool-name">技能</span>
    ...
    >
      ...
      <div class="skill-meta">
        <div class="meta-row">
          ...
          <code class="meta-value skill-code">{{ skillName }}</code>
        </div>
        <div class="meta-row">
      ...
      >
        ...
        >
          <span class="section-title">技能提示</span>
...
.skill-tool.status-pending {
  border-left-color: #6c757d;
}

.skill-tool.status-completed {
  border-left-color: #28a745;
}

.skill-tool.status-failed {
  border-left-color: #d73a49;
}

.tool-name {
  color: #d63384; /* Pink color for skills */
}
...
.theme-dark .tool-name {
  color: #e685b5; /* Lighter pink for dark theme */
}

.theme-dark .skill-name {
  background: rgba(230, 133, 181, 0.15);
  border-color: rgba(230, 133, 181, 0.3);
  color: #e685b5;
}
