package com.claudecodeplus.plugin.converters
...
object DisplayItemConverter {
    ...
    fun convertToDisplayItems(
        messages: List<com.claudecodeplus.sdk.types.Message>,
        pendingToolCalls: MutableMap<String, ToolCallItem>
    ): List<DisplayItem> {
    ...
    fun convertMessageToDisplayItems(
        message: com.claudecodeplus.sdk.types.Message,
        pendingToolCalls: MutableMap<String, ToolCallItem>
    ): List<DisplayItem> {
        val displayItems = mutableListOf<DisplayItem>()
     ...
     * 生成消息 ID
     */
    private fun generateMessageId(message: com.claudecodeplus.sdk.types.Message, index: Int): String {
        return when (message) {
